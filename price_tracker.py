...
Info  : https://brightdata.de/products/insights/price-tracker/wallapop
"""
...
# https://brightdata.de/products/web-scraper/wallapop
DATASET_ID = os.getenv("BRIGHTDATA_DATASET_ID", "")
if not DATASET_ID:
    raise EnvironmentError(
        "BRIGHTDATA_DATASET_ID is not set.\n"
        "1. Build your Wallapop scraper at: https://brightdata.de/products/web-scraper/wallapop\n"
